@REM Copies the JynxFramework.h and cpp files from the development repository
copy /Y ..\JynxFramework\JynxFramework\JynxFrameworkPanic.h Portable
copy /Y ..\JynxFramework\JynxFramework\JynxFrameworkPanic.cpp Portable
copy /Y ..\JynxFramework\JynxFramework\JynxFramework.h Portable
