	...
	constructor(options) 
	{
		...
		WebAssembly
			...
			.then(function(instance) {
				...
				// Low-level bootstrapping the C++

				let panicPointerAddress = instance.exports.GetPanicMessagePointerAddress();
				console.log('The panic-message pointer is located at WASM address: ' + panicPointerAddress);
				console.log(instance);

				instance.exports.InitBeforeCtorsCalled();
				instance.exports.__wasm_call_ctors();
				instance.exports.CreateJynxEmulatorSingleton();
