...
namespace Jynx
{
	...
	public:
		...
		// Used by TapeSignalRLEBuilder, not really of interest elsewhere.
	...
	public:
		...
		TapeSignalRLEBuilder( const SignalLengthInfo &forZeroes, const SignalLengthInfo &forOnes );
		...
		// Returns the tape data by move-semantics.
		// This object enters empty state.
		JynxFramework::Array<SignalRLE> GetRLETapeData();

	private:

		JynxFramework::ArrayBuilder<SignalRLE> _rleBuilder;
